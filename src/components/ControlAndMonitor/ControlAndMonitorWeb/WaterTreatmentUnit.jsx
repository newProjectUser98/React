...
import arrow from '../../../assets/images/triangle-arrow.png'
import { useState } from 'react'
import { rawtank,rawtankgray, rawtankred } from '../../../data/WaterTreatmentUnitSVG/rawtank'
import { rwpmotor, rwpmotorgray, rwpmotorred } from '../../../data/WaterTreatmentUnitSVG/motor'
import { feedflowsensor, feedflowsensorgray, feedflowsensorred } from '../../../data/WaterTreatmentUnitSVG/feedflowsensor'
import { ampv1svg, ampv1svggray, ampv1svgred } from '../../../data/WaterTreatmentUnitSVG/ampv1'
import { ampv2svg, ampv2svggray,ampv2svgred } from '../../../data/WaterTreatmentUnitSVG/ampv2'
import { filterbig1svg, filterbig1svggray,filterbig1svgred } from '../../../data/WaterTreatmentUnitSVG/filterbig1'
import { filterbig2svg, filterbig2svggray, filterbig2svgred } from '../../../data/WaterTreatmentUnitSVG/filterbig2'
import { dosingpumpsvg, dosingpumpsvggray, dosingpumpsvgred } from '../../../data/WaterTreatmentUnitSVG/dosingpump'
import { filtersmall1svg, filtersmall1svggray, filtersmall1svgred } from '../../../data/WaterTreatmentUnitSVG/filtersmall1'
import { filtersmall2svg, filtersmall2svggray, filtersmall2svgred } from '../../../data/WaterTreatmentUnitSVG/filtersmall2'
import { iotmodulesvg, iotmodulesvggray, iotmodulesvgred } from '../../../data/WaterTreatmentUnitSVG/iotmodule'
import { lpsrangesvg, lpsrangesvggray, lpsrangesvgred } from '../../../data/WaterTreatmentUnitSVG/lpsrange'
import { hpprangesvg, hpprangesvggray, hpprangesvgred } from '../../../data/WaterTreatmentUnitSVG/hpprange'
import { roipanelsvg, roipanelsvggray, roipanelsvgred } from '../../../data/WaterTreatmentUnitSVG/roipanel'
import { hpsrangesvg, hpsrangesvggray, hpsrangesvgred,  } from '../../../data/WaterTreatmentUnitSVG/hpsrange'
import { membranesvg, membranesvggray, membranesvgred } from '../../../data/WaterTreatmentUnitSVG/membrane'
import { premeateflowsensorsvg, premeateflowsensorsvggray, premeateflowsensorsvgred } from '../../../data/WaterTreatmentUnitSVG/premeateflowsensor'
import { cunductivitysvg, cunductivitysvggray, cunductivitysvgred } from '../../../data/WaterTreatmentUnitSVG/cunductivity'
import { tankrightsvg, tankrightsvggray, tankrightsvgred } from '../../../data/WaterTreatmentUnitSVG/tankright'
